const Blogs = () => {
    return (
        <div>
            <section className="text-gray-600 body-font dark:bg-slate-900" style={{ backgroundImage: "url(/img/circles.svg)", backgroundSize: "cover" }}>
                <div className=''>
                    <span className="icon-[logos--react]"></span>
