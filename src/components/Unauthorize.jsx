...
const Unauthorize = () => {
    return (
        <div className="relative h-screen w-screen">
            <div className="absolute top-0 left-0 h-full w-full bg-gradient-to-br from-red-900 via-red-800 to-purple-900"></div>
            <div className="wrap absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            ...
            <h2 className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-4xl text-white font-audiowide">
                Page Not Found
            </h2>
        </div>
    )
