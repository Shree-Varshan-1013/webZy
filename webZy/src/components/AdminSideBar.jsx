...
const AdminSideBar = () => {
    return (
        <div className="flex flex-col items-center w-40 h-screen overflow-hidden text-gray-400 bg-white dark:bg-slate-900 font-anuphan backdrop-blur bg-opacity-90" style={{backgroundImage:"url(/img/adminSideNavbar.svg)", backgroundRepeat:"no-repeat", backgroundSize:"cover"}}>
            ...
            <div className="w-full px-2">
                <div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
                    ...
                    <a className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" href="#">
                        ...
                        <span className="ml-2 text-sm font-medium text-black dark:text-caramel">Docs</span>
                    </a>
                </div>
