    ...
    return (
        <header className="select-none text-gray-600 body-font sticky top-0 z-[1100] w-full font-anuphan dark:bg-slate-500 ">
            <div className="container mx-auto flex flex-wrap p-4 flex-col md:flex-row items-center absolute backdrop-blur bg-opacity-90 dark:bg-opacity-20">
                ...
                {
                    isLoggedIn ? (<ProfileDropdown />) : (<a onClick={() => navigate("/sign-in")} className="cursor-pointer relative inline-flex items-center justify-center p-4 px-3 py-2 overflow-hidden font-medium text-purple2 transition duration-300 ease-out border-2 border-purple rounded-full shadow-md group">
