...
const PageNotFound = () => {
    ...
    return (
        ...
        >
            <div className="select-none w-full h-screen flex flex-col items-center justify-center dark:bg-slate-900" style={{ backgroundImage: "url(/img/banner.svg)", backgroundSize: "cover" }}>
